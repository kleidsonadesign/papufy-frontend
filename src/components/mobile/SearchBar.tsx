      ...
      <div className="page-container py-2">
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-xs font-semibold text-papufy-orange">
              {locationLabel} 📍
            </p>
          </div>
        </button>
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative min-w-0 flex-1">
                <input
                  ...
                  className="w-full rounded-full border border-papufy-border py-3 pl-4 pr-11 text-base outline-none focus:border-papufy-orange focus:ring-2 focus:ring-papufy-orange/20"
                />
                <button
                  type="submit"
                  className="touch-target absolute right-1 top-1/2 -translate-y-1/2 rounded-full p-2 text-papufy-orange"
                  aria-label="Buscar"
                >
                  <IconSearch />
                </button>
