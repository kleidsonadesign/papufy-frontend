...
export function BottomNav() {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-50 border-t border-papufy-border bg-white/95 pb-[env(safe-area-inset-bottom,0px)] shadow-[0_-4px_24px_rgba(0,0,0,0.08)] backdrop-blur-md"
